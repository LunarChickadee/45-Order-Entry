...
;;drawobjects //this only works while editing a form
...
string_zip=rep(chr(48),5-length(str(Zip)))+str(Zip)
...
caption="How Would You Like to Search?
Cancel=Stop" captionstyle=bold captionheight="2" height="250" 
}
if info("dialogtrigger") contains "cancel"
Stop
endif
